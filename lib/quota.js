 ...
 *
 * Bounds abuse once public multi-tenant sign-up opens (#219). Five state caps:
 ...
 *   - accepted friends per user           (checked in lib/routes/friends.js)
 *   - open outgoing friend requests per user (checked in lib/routes/friends.js)
