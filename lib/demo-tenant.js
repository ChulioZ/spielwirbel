 ...
 * survives a multi-process deployment (#215's shared store was closed
 * unshipped) where anything held in memory would classify the same tenant
 * differently depending on which replica answered.
 *
