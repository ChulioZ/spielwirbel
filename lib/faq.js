 ...
 *    roadmap, nothing the code does not do today. **Pointing at an open issue
 *    is not a roadmap statement and is allowed** — "whether and how it arrives
 *    is discussed in issue #485" is a present, checkable fact and stays true
 *    however that issue ends, whereas "an export is planned" is a promise that
 *    goes stale on its own the moment the plan changes. Link the discussion,
 *    never predict its outcome.
...
nicht. Ob und wie er kommt, wird offen in
<a href="${REPO_URL}/issues/485" rel="noopener">Issue&nbsp;#485</a>
besprochen.</p>`,
    },
    en: {
...
<p>There is currently no one-click export from inside the app itself. Whether
and how one arrives is discussed in the open in
<a href="${REPO_URL}/issues/485" rel="noopener">issue&nbsp;#485</a>.</p>`,
    },
  },
  {
    id: 'data',
