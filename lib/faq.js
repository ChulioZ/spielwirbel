...
account-mails (adres bevestigen, wachtwoord herstellen).</p>
...
tavanomaiset tilisähköpostit (osoitteen vahvistus, salasanan palautus).</p>
...
<strong>친구 요청</strong>입니다. 여기에 계정 관련 메일(주소 확인, 비밀번호 재설정)이
더해집니다.</p>
