...
<p>Solange niemand schlechter als „geht so" bewertet hat, ist der Score genau der
gewohnte Durchschnitt. Er weicht erst ab, wenn es etwas zu sagen gibt — und dann
steht daneben, was es war, etwa „1× gar nicht". Den reinen Durchschnitt aller
Bewertungen findet ihr weiterhin unten auf der Seite des Spiels.</p>`,
    },
    en: {
...
<p>As long as nobody rated below „so-so", the score is exactly the average you
are used to. It only diverges when there is something to say — and then it says
what, right beside it, for example „1× not at all". The plain average of all
ratings is still shown at the bottom of the game's page.</p>`,
    },
  },
  {
    id: 'mail',
