 ...
 *    roadmap, nothing the code does not do today.
...
<p>Eine Runde läuft von einem Gerät: Ihr gebt das Handy oder Tablet beim
Abstimmen herum, statt dass sich alle einzeln anmelden.</p>`,
    },
    en: {
...
<p>A round runs from one device: you pass the phone or tablet around to vote,
rather than everyone signing in separately.</p>`,
    },
  },
  {
    id: 'free',
...
<p>Ein Export direkt in der App — ein Klick, eine Datei — ist geplant, aber noch
nicht gebaut.</p>`,
    },
    en: {
...
<p>An export from inside the app — one click, one file — is planned but not
built yet.</p>`,
    },
  },
  {
