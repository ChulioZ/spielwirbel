...
<p>Dazu kommen vier Abzeichen für dein <strong>Konto</strong> über alle Runden
hinweg: Sessions, Siege, Runden und Jahre. Sie stehen auf deinem Profil, und nur du
und deine Freundschaften sehen sie. Erreichst du bei Sessions oder Siegen eine neue
Stufe, sehen deine Freundschaften das im Freundeskreis — nur Name und Stufe, nie die
Runde. Hast du deine Bilanz für Freundschaften ausgeschaltet, bleibt beides
verborgen.</p>`,
    },
    en: {
...
<p>On top of that, your <strong>account</strong> has four badges across all your
rounds: Sessions, Wins, Rounds and Years. They are on your profile, and only you and
your friends see them. When you reach a new tier of Sessions or Wins, your friends
see it in their Friends feed — just the name and the tier, never the round. If you
have switched your record off for friends, both stay hidden.</p>`,
    },
    es: {
...
<p>Además, tu <strong>cuenta</strong> tiene cuatro insignias que abarcan todos
tus grupos: Sesiones, Victorias, Grupos y Años. Están en tu perfil y solo las ves tú
y tus amistades. Cuando alcanzas un nuevo nivel de Sesiones o Victorias, tus amistades
lo ven en Amigos: solo el nombre y el nivel, nunca el grupo. Si has ocultado tu
balance a tus amistades, ambas cosas quedan ocultas.</p>`,
    },
    fr: {
...
<p>Votre <strong>compte</strong> a en plus quatre badges qui couvrent tous vos
groupes : Sessions, Victoires, Groupes et Années. Ils figurent sur votre profil, et
seuls vous et vos amis les voyez. Quand vous atteignez un nouveau palier de Sessions
ou de Victoires, vos amis le voient dans Amis — seulement le nom et le palier, jamais
le groupe. Si vous avez masqué votre bilan à vos amis, les deux restent cachés.</p>`,
    },
    it: {
...
<p>In più il tuo <strong>account</strong> ha quattro distintivi che valgono per
tutti i tuoi gruppi: Sessioni, Vittorie, Gruppi e Anni. Sono sul tuo profilo e li
vedete solo tu e i tuoi amici. Quando raggiungi un nuovo livello di Sessioni o
Vittorie, i tuoi amici lo vedono in Amici: solo il nome e il livello, mai il gruppo.
Se hai nascosto il tuo bilancio agli amici, restano nascosti entrambi.</p>`,
    },
    nl: {
...
<p>Daarnaast heeft je <strong>account</strong> vier badges over al je groepen
heen: Sessies, Zeges, Groepen en Jaren. Ze staan op je profiel, en alleen jij en je
vrienden zien ze. Bereik je bij Sessies of Zeges een nieuw niveau, dan zien je
vrienden dat bij Vrienden — alleen de naam en het niveau, nooit de groep. Heb je je
overzicht voor vrienden uitgezet, dan blijft allebei verborgen.</p>`,
    },
    pt: {
...
<p>Além disso, a tua <strong>conta</strong> tem quatro insígnias que abrangem
todos os teus grupos: Sessões, Vitórias, Grupos e Anos. Estão no teu perfil, e só tu
e os teus amigos as veem. Quando chegas a um novo nível de Sessões ou Vitórias, os
teus amigos veem-no em Amigos — só o nome e o nível, nunca o grupo. Se ocultaste o
teu balanço aos amigos, ambos ficam ocultos.</p>`,
    },
    fi: {
...
session alle.</p>
<p>Lisäksi <strong>tililläsi</strong> on neljä merkkiä, jotka kattavat kaikki
ryhmäsi: Sessiot, Voitot, Ryhmät ja Vuodet. Ne näkyvät profiilissasi, ja vain sinä
ja kaverisi näette ne. Kun saavutat uuden tason Sessioissa tai Voitoissa, kaverisi
näkevät sen Kaverit-näkymässä — vain nimen ja tason, ei koskaan ryhmää. Jos olet
piilottanut tilastosi kavereilta, molemmat pysyvät piilossa.</p>`,
    },
    ko: {
...
<p>또한 <strong>계정</strong>에는 모든 그룹을 아우르는 배지 네 개가 있습니다: 세션,
승리, 그룹, 연차. 프로필에 표시되며 나와 친구만 볼 수 있습니다. 세션이나 승리에서 새
단계에 오르면 친구들이 친구 화면에서 그 소식을 봅니다. 이름과 단계만 보이고 그룹은 절대
보이지 않습니다. 친구에게 기록을 숨겨 두었다면 둘 다 보이지 않습니다.</p>`,
    },
  },
  {
    id: 'mail',
