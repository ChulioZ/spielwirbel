...
/* The two predicates the setup screen's live preview applies to the same games
   ...
   import. */
const { isActiveGame, fitsPlayerCount, fitsMetadataFilters } = require('../public/js/draw-pool');
...
function drawPool(round, { tagIds = null, excludeTagIds = null, tagMode = 'all', metadata = null, playerCount, multiTable = false } = {}) {
