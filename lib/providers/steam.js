 ...
 * instead of throwing. Steam has no player-count or play-time fields; player
 * count is inferred best-effort from the (locale-independent) category ids and
...
function parseAppDetails(json, appId) {
  ...
  return {
    ...
    maxPlayers: max,
    type: 'digital',
    duration: 'long', // Steam has no play-time field; default digital titles to the long bucket
