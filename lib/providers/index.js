...
// The frozen list, for the one caller that has to CLEAR the rows pointing at it
// (#981's admin action). Read-only copy: the whole point of the freeze is that
// nothing prunes it while covers still depend on it.
const legacyCoverHosts = () => [...LEGACY_COVER_HOSTS];
