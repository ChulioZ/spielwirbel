 ...
 * so the requesting user's UI locale has to reach them — see routes/lookup.js.
...
// 'en' and 'de' (SUPPORTED_LOCALES in public/js/i18n.js); the rest are here so
// the storefront half is already correct when more UI locales land (#504).
//
