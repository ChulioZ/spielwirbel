 ...
 *
 * WHY IT EXISTS. Scoring a few thousand candidates is microseconds; READING them
 * is not. A 5000-row corpus is a multi-megabyte answer from the store, and
 * `GET …/recommendations` would pay it per request — the same
