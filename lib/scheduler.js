...
// unusable the moment it expires because its tokens are rejected, and an expired
// vote link is refused by the route's own gate — both independently of when this
// sweep gets round to deleting the row.
