...
// hashed at rest, exactly as before — the stored record shape is unchanged, and
// a legacy link (bare secret + separate uid=) still verifies.
//
...
// (wrong version, wrong shape). A legacy bare token contains no '.' at all —
// base64url has no dot in its alphabet — so the two forms can never be confused.
