...
// The two mailed one-time links (#434). Distinct prefixes so a verification
// token can never be replayed against the reset endpoint or vice versa, even
// though both hash into the same `tokenHash` field shape.
