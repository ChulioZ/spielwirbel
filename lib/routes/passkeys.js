...
// The terms-change notice (#521) rides on the login response for the same
// reason it rides on POST /login: the client seats `accountUser` straight from
// it, so without these the banner would stay hidden until the next cold load.
