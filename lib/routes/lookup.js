...
// The lazy weight/description backfill (#717): the import is its third trigger
...
router.post('/import', async (req, res) => {
  ...
  // Fill weight/description for what just landed (#717 follow-up). The reported
  // gap was import → draw → vote with no info anywhere: a collection body
  // carries neither field, and the session-start backfill races the first
