...
//
// Bounded per press, like SIZE_SAMPLE_MAX above: each object costs a read plus a
// decode, so a bucket-sized run in one request would hold a connection for
// minutes. The response says what was left, and the run is resumable because
// converted objects are skipped on the next press.
const REENCODE_BATCH_MAX = 200;
