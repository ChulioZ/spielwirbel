...
// Handles that would read as an official account. Required out of public/js on
// purpose: the register form offers the same check, and a second copy here would
// drift (.claude/rules/shared-constants-across-the-stack.md).
const { isReservedUsername } = require('../../public/js/reserved-usernames');
