...
const PRIVACY_REVISION = '2026-07-29';
...
// Whether that user should be shown the notice.
function termsChangedFor(user) {
  const { acceptedTermsRevision, termsRevision } = termsAcceptanceOf(user);
...
module.exports = {
  ...
  termsAcceptanceOf, termsChangedFor,
};
