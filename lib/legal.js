...
Preise werden nicht gespeichert, sondern nur für kurze Zeit zwischengespeichert,
damit dieselbe Seite nicht bei jedem Aufruf erneut abgefragt wird. Neben dem
...
personal data arises from this. Prices are not stored, only briefly cached so
that opening the same page again does not repeat the request. Beside the price we
