...
<h2>9. E-Mail-Versand (Scaleway)</h2>
...
Meldungen) versenden wir über <strong>Scaleway SAS, Paris,
Frankreich</strong> — einen EU-Anbieter, dessen Server in Frankreich stehen und
mit dem ein Auftragsverarbeitungsvertrag besteht. Verarbeitet werden dabei
...
uns per E-Mail über Scaleway zugestellt und im Postfach des Betreibers gespeichert,
...
Erklärung genannten Empfänger (Railway, Cloudflare, Scaleway, Heinlein Hosting,
ZERODOX — jeweils
...
<h2>9. E-mail delivery (Scaleway)</h2>
...
<strong>Scaleway SAS, Paris, France</strong> — an EU provider whose servers are
located in France, under a data-processing agreement. Recipient address,
subject and message content are processed for delivery (Art. 6(1)(b) GDPR).</p>
...
Scaleway and kept in the operator's mailbox as long as handling requires. The same
...
(Railway, Cloudflare, Scaleway, Heinlein Hosting, ZERODOX — each to the
