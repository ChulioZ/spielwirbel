...
// The date shown as "Stand" on all three documents (Impressum, privacy policy,
// Nutzungsbedingungen). Bump when the content of any of them changes.
const REVISION = '2026-07-29';
