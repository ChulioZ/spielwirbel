...
const PRIVACY_REVISION = '2026-09-08';
...
<p><strong>Neu verknüpfen</strong> lassen sich Cover nur noch über
BoardGameGeek. Die übrigen Anbieter stehen weiterhin in dieser Liste, weil
früher verknüpfte Cover unverändert von dort geladen werden — an der Liste der
Empfänger ändert sich dadurch nichts.</p>
...
<p><strong>New</strong> covers can only be linked from BoardGameGeek. The other
providers remain on this list because covers linked earlier are still loaded
from them — the list of recipients is unchanged by that.</p>
