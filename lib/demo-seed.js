...
const DEMO_TAGS = {
  classic: { icon: 'cards', de: 'Klassiker', en: 'Classic', es: 'Clásicos' },
  family: { icon: 'users', de: 'Familie', en: 'Family', es: 'Familiar' },
  party: { icon: 'sparkles', de: 'Party', en: 'Party', es: 'Fiesta' },
  duel: { icon: 'sword', de: 'Zu zweit', en: 'Two player', es: 'Para dos' },
};
