...
const DEMO_TAGS = {
  classic: { icon: 'cards', de: 'Klassiker', en: 'Classic', es: 'Clásicos', fr: 'Classiques', it: 'Classici', nl: 'Klassiekers' },
  family: { icon: 'users', de: 'Familie', en: 'Family', es: 'Familiar', fr: 'Famille', it: 'Famiglia', nl: 'Familie' },
  party: { icon: 'sparkles', de: 'Party', en: 'Party', es: 'Fiesta', fr: 'Ambiance', it: 'Festa', nl: 'Feest' },
  duel: { icon: 'sword', de: 'Zu zweit', en: 'Two player', es: 'Para dos', fr: 'À deux', it: 'In due', nl: 'Met z’n tweeën' },
};
...
const DEMO_TEXT = {
  ...
  nl: {
    roundName: 'Spelletjesavond (demo)',
    ownerSeat: 'Jij',
    members: ['Sanne', 'Bram', 'Femke'],
  },
};
