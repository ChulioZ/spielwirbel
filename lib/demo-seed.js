...
const DEMO_TAGS = {
  classic: { icon: 'cards', de: 'Klassiker', en: 'Classic', es: 'Clásicos', fr: 'Classiques' },
  family: { icon: 'users', de: 'Familie', en: 'Family', es: 'Familiar', fr: 'Famille' },
  party: { icon: 'sparkles', de: 'Party', en: 'Party', es: 'Fiesta', fr: 'Ambiance' },
  duel: { icon: 'sword', de: 'Zu zweit', en: 'Two player', es: 'Para dos', fr: 'À deux' },
};
...
const DEMO_SESSIONS = [
  ...
  },
  {
    ...
    chosenIndex: 4,
    winners: [0, 2],
    /* The 0 in the last column is a retirement proposal, not a rating — the
       zero of the scale (#797). One of the four, on purpose; see the arithmetic
       in lib/demo.js's seedSessions. */
    ratings: [
      [4, 5, 0],
      [3, 5, 4],
      [5, 5, 5],
