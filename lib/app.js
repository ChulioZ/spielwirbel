...
function createApp() {
  ...
  // public face reads as broken. Values are read per request like every other
  // env ceiling in this file; mounted ahead of the auth gates because the
  // footer renders on the login page too. Never put anything sensitive in
  // this response.
  app.get('/api/config', (req, res) => {
    res.json({ footer: mail.isConfigured() && legal.legalConfigured() });
  });
