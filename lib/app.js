...
function createApp() {
  ...
  app.get('/api/config', (req, res) => {
    ...
    res.json({
      ...
      savedFilters: require('./routes/saved-filters').savedFilterLimits(), // #1328, see there
  ...
  // The round's colour marker (#1187). The per-round design route it replaced
  // (POST /background) was retired at the flip (#1202).
  app.use('/api/rounds/:rid/marker', require('./routes/marker'));
  app.use('/api/rounds/:rid/tags', require('./routes/tags'));
  app.use('/api/rounds/:rid/filters', require('./routes/saved-filters'));
