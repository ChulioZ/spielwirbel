...
const ROUND_OBJ = "jsonb_build_object('id', id, 'name', name, 'background', background, 'marker', marker, 'tags', tags, 'lastSessionFilters', last_session_filters, 'dismissedRecommendations', dismissed_recommendations)";
...
const ROUND_META_OBJ = "jsonb_build_object('id', id, 'name', name, 'background', background, 'marker', marker, 'tags', tags, 'lastSessionFilters', last_session_filters)";
