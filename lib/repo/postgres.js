...
// Mirrors the JSON backend's helper of the same name (#717, #724) — see it for
// why values only accrete and why an empty category list is skipped rather than
// stored. A deliberate second copy, like `sameSource`, with the shared contract
// suite as the guard against drift.
