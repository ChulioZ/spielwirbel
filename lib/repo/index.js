 ...
 * since #321 the write is reached on the module-level repo from routes/contact.js
 * (the 'feedback' category of the public contact form) and the read/delete only
 * from the admin-gated routes/admin.js.
 *
 ...
 * and reached from the account routes (routes/friends.js), which scope every query
