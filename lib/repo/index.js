 ...
 * admin-gated routes (lib/routes/admin.js) — never via req.repo, which is all an
 ...
 * from the admin-gated lib/routes/admin.js.
 *
 ...
 * TENANT_METHODS; written only from the admin-gated lib/routes/admin.js and the
