 ...
 * Postgres 16 before the design was settled, and re-verified on 18.4 in 2026-08):
 ...
 * cross-tenant DELETE = 0 rows and cross-tenant INSERT is refused. The rule file
 * that recorded this (retenant-rls-escape.md) went with the cross-tenant write
 * escape in #405; .claude/rules/admin-cross-tenant-escape.md carries what survived.
 */
