...
// The group's own verdict on one of its games, on the 0–5 rating scale, or null
// when nobody has rated it. A vote proposing retirement counts as the 0 it is
// (#797, public/js/vote-scale.js) — the strongest thing a voter can say about a
// game they have played, and leaving it out used to make a game half the group
...
function gameAffinity(round, game, playScale) {
  ...
  return (avg === null ? A_UNRATED : (avg - 1) / 2) + bonus;
}
