...
/* The Freundeskreis feed's event types (#325): what `addFeedEvent` will store.
   ...
   phrased — is public/js/feed-view.js (`feedText` for the ROW and `feedTileVerb`
   for the tile since #1132; a fourth type needs a branch in both). It used to
   render any
   ...
   plural, so feedText() now branches per type. A fourth type needs one too.
