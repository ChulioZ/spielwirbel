...
Self-hostable, German + English + Spanish + French + Italian + Dutch + Portuguese + Finnish UI, no tracking. Try it without an account at
...
npm run dev           # the server, restarted on every backend file change
