...
public/
  ...
  robots.txt         crawl policy; the noindex'd pages stay crawl-ALLOWED (#510)
...
| **`audit`** | Runs the full audit sweep — accessibility, legal, security, UI, and Claude-file — in one pass, merges the results into one ranked report, and files issues only with your approval. |
