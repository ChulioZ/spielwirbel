...
const SOURCE_ALLOW = {
  ...
  'lib/routes/admin.js': 'recorded 2026-09-07 at 1124 lines — on the list since 2026-07-30. The seam test was applied by the 2026-09-08 audit sweep and it PASSES: 16 self-labelled sections, exactly one helper crossing a boundary (sendCsv, a 9-line wrapper over the shared lib/csv.js), and four sections owned by disjoint docs. The neighbours\' deferral ("splitting one resource\'s router would be a new pattern") does not apply — admin is ~15 sub-resources, and lib/app.js:343-409 already mounts five sub-routers under /api/account. Tracked as #996, sequenced behind #941; left `recorded` deliberately until that lands rather than re-judged here',
