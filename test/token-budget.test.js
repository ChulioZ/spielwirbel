...
const SOURCE_ALLOW = {
  ...
  'public/js/views-regal.js': 'recorded 2026-09-12 at 762 lines — crossed by #1000 adding the fourth bulk action (a tri-state tag picker plus its confirm). The seam is visible and I judged it FALSE AS WRITTEN rather than unexamined: lines 145-474 are the selection mode and its four bulk actions, all nested INSIDE renderRegalTab as a closure over round, rid, grid, selection, selecting, shownCards, bulkBar and renderGames — two of them mutable, so extracting needs an eight-entry context object with getters, i.e. a refactor with behaviour risk rather than a file move. That refactor is the real answer and wants its own issue; recorded rather than judged because I did not do it',
