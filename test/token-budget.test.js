...
const SOURCE_ALLOW = {
  ...
  'public/js/views-chronik.js': 'recorded 2026-09-25 at 715 lines — crossed by #1218, Ocean\'s session ROW (one more design branch beside Der Tisch\'s strip, the same shape) and its month count. A seam IS visible and unjudged: the period recap and the share delivery (renderPeriodRecapSection, canShareRecapImage, shareRecapCard, deliverShareImage — the last also serving views-shelf-profile.js) are independently editable from the timeline above them. Not split in #1218, which was built in a batch of parallel Ocean slices; the split is free to do now (the recap share card #1220, which will edit that half, was not in the batch). M-001\'s worklist item',
