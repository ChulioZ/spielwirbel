...
const RULE_ALLOW = {
  ...
  '.claude/rules/setup-screens-two-column-layout.md': 'judged 2026-09-11 — 178 lines, crossed by #1015 adding §5: the two-column layout of #577 was NOT enough on its own, and the layout-only alternative was prototyped and measured failing. It sat at 130. No seam: this is ONE screen pair\'s layout contract and every section is a clause of it — §1 is the exemption, §2 the licence for choosing a width by content at all, §3 the two pool presentations that live inside it, §4 the DOM order the columns impose, and §5 is defined BY CONTRAST with §1-4 (widening a column cannot remove content), so filing it away is precisely how the next session re-derives the alternative that was already measured failing. The measured tables are what a trim would take, and they are the reason the file exists rather than a restatement of its heading',
  // judged 2026-08-01
