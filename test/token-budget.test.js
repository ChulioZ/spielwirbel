...
const SOURCE_ALLOW = {
  ...
  'public/js/core.js': 'recorded 2026-09-07 at 1276 lines — SPLIT by #956: the design/theme block (resolveAccent, setWorld, setScheme, isDarkScheme, setThemeColor, applyBackground, avgColor) left as public/js/round-theme.js, taking it from 1397. Still over budget and still NOT judged, because the seams that remain are real and were out of #956\'s scope: the score/stats block (scoreFields -> retireRecommendations), the anchored-popover machinery and the tag-chip UI are edited by different feature streams and none of them needs the others open. The theme block went first because it was the cleanest cut — it reads no round, game or vote, and its only dependency is round-designs.js. M-001\'s worklist item',
  'public/js/views-round-detail.js': 'recorded 2026-09-07 at 1374 lines — on the list since 2026-07-30, never judged: game detail plus the sheet/editor machinery',
