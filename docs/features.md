...
- **Entdecken** – *off unless the operator enables it* (issue #564). Publishes
  the whole instance at a glance: how many accounts, rounds, games and nights
  played it holds, plus the games on the most shelves, the ones played most this
  week / month / year, and the best-rated. It appears on the logged-out landing
  ...
  it (a ranking needs several *different* groups, not one group playing a lot),
