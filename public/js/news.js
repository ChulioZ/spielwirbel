   ...
   */
  {
    ...
    de: {
      ...
      body: 'Unter Pokale gibt es jetzt Abzeichen — für die Runde und für jede '
        ...
        + 'Dazu zeigt dein Profil vier Konto-Abzeichen über alle Runden, und unter '
        + '„Neues aus dem Freundeskreis" sehen Freunde, wenn du eine neue Stufe '
        + 'erreichst.',
    },
    en: {
      ...
      body: 'Trophies now has badges — for the round and for each person: the '
        ...
        + 'that earned it. '
        + 'Your profile also shows four account badges across all your rounds, and '
        + 'friends see under Friends’ activity when you reach a new tier.',
    },
    es: {
      ...
      body: 'En Trofeos ahora hay insignias, para el grupo y para cada persona: '
        ...
        + 'Tu perfil muestra además cuatro insignias de cuenta de todos tus grupos,'
        + ' y tus amigos ven en «Actividad de tus amigos» cuando alcanzas un nuevo '
        + 'nivel.',
    },
    fr: {
      ...
      body: 'Trophées propose maintenant des badges, pour le groupe et pour chaque '
        ...
        + 'Ton profil affiche aussi quatre badges de compte, tous groupes '
        + 'confondus, et tes amis voient dans « Activité de tes amis » quand tu '
        + 'atteins un nouveau palier.',
    },
    it: {
      ...
      body: 'In Trofei ora ci sono i distintivi, per il gruppo e per ogni persona: '
        ...
        + 'Il tuo profilo mostra anche quattro distintivi dell\'account su tutti i '
        + 'gruppi, e gli amici vedono in «Attività degli amici» quando raggiungi un'
        + ' nuovo livello.',
    },
    nl: {
      ...
      body: 'Bij Trofeeën zijn er nu badges, voor de groep en voor iedereen: de '
        ...
        + 'Je profiel toont ook vier accountbadges over al je groepen, en vrienden '
        + 'zien bij „Activiteit van vrienden" wanneer je een nieuw niveau haalt.',
    },
    pt: {
      ...
      body: 'Em Troféus há agora insígnias, para o grupo e para cada pessoa: a '
        ...
        + 'O teu perfil mostra também quatro insígnias de conta de todos os grupos,'
        + ' e os amigos veem em «Atividade dos amigos» quando chegas a um novo '
        + 'nível.',
    },
    fi: {
      ...
      body: 'Palkinnoissa on nyt merkkejä, porukalle ja jokaiselle: ensimmäinen '
        ...
        + 'se ansaittiin. '
        + 'Profiilisi näyttää lisäksi neljä tilimerkkiä kaikista porukoistasi, ja '
        + 'kaverit näkevät Kavereiden toiminnassa, kun saavutat uuden tason.',
    },
    ko: {
      title: '모임을 위한 배지',
      body: '이제 트로피에 배지가 있어요. 모임과 한 사람 한 사람을 위한 것으로, 첫 승리, '
        ...
        + '세션 아래에 남아요. '
        + '프로필에는 모든 모임을 합친 계정 배지 네 개도 보이고, 새 단계에 오르면 친구들이 ‘친구들의 활동’에서 볼 수 있어요.',
    },
  },
  /*
   ...
   */
  {
    ...
    es: {
      ...
      body: 'Tu propio perfil tiene ahora «Tu resumen»: elige un mes o un año y mira '
        ...
        + 'puedes verlo, y «Compartir» lo convierte en una imagen para el chat del '
        + 'grupo.',
    },
    fr: {
   ...
   */
  {
    ...
    es: {
      ...
      body: 'Los grupos cambian y, hasta ahora, la lista de miembros solo podía crecer. Ahora '
        + 'puedes quitar a un miembro del grupo desde su propia página. La persona '
        + 'desaparece de '
        + 'la lista de asientos, de los equipos, de las clasificaciones y de los '
        + 'Trofeos; todo lo '
        + 'que haya votado y ganado alguna vez queda exactamente como estaba, y ninguna '
        + 'Puntuación Spielwirbel cambia por ello. Volver a incorporarla es '
        + 'cuestión de un toque. '
        + 'Si un asiento se creó por error y todavía no tiene nada asociado, puedes'
        + ' borrarlo del '
        + 'todo en su lugar.',
    },
    fr: {
      ...
      body: 'Les groupes évoluent, et jusqu’ici la liste des membres ne pouvait que s’allonger. '
        + 'Vous pouvez désormais retirer un membre du groupe depuis sa propre page.'
        + ' La personne '
        + 'disparaît de la liste des places, des équipes, des classements et des '
        + 'Trophées ; tout '
        + 'ce qu’elle a voté et gagné reste exactement en l’état, et aucun Score '
        + 'Spielwirbel ne '
        + 'bouge pour autant. La réintégrer ne prend qu’une touche. Si une place a '
        + 'été créée par '
        + 'erreur et que rien n’y est encore rattaché, vous pouvez tout simplement '
        + 'la supprimer.',
    },
    it: {
      ...
      body: 'I gruppi cambiano e finora l’elenco dei membri poteva soltanto crescere. Ora puoi '
        ...
        + 'dall’elenco dei posti, dalle squadre, dalle classifiche e dai Trofei; '
        + 'tutto ciò che ha '
        + 'votato e vinto resta esattamente com’era, e nessun Punteggio Spielwirbel'
        + ' si sposta per '
        + 'questo. Riaccoglierla è questione di un tocco. Se un posto è nato per '
        + 'sbaglio e non ha '
    ...
    nl: {
      ...
      body: 'Groepen veranderen, en tot nu toe kon de ledenlijst alleen maar groeien. Je kunt een '
        + 'lid nu vanaf zijn eigen pagina uit de groep verwijderen. De persoon '
        + 'verdwijnt uit de '
        + 'zitplaatsen, de teams, de standen en de Trofeeën; alles waarop diegene '
        + 'ooit heeft '
        + 'gestemd en wat diegene heeft gewonnen blijft precies zoals het was, en '
        + 'geen enkele '
        + 'Spielwirbel-score verandert erdoor. Weer opnemen kan altijd. Is een plek'
        + ' per ongeluk '
    ...
    pt: {
      ...
      body: 'Os grupos mudam e, até agora, a lista de membros só podia crescer. Agora dá para '
        + 'remover um membro do grupo na página dele. A pessoa sai da lista de '
        + 'lugares, das '
        + 'equipes, das classificações e dos Troféus; tudo em que ela já votou e '
        + 'tudo que ganhou '
        + 'continua exatamente como estava, e nenhuma Pontuação Spielwirbel muda '
        + 'por causa disso. '
        + 'Trazer de volta é um toque. Se um lugar foi criado por engano e ainda '
        + 'não tem nada '
      ...
      body: 'Porukat muuttuvat, ja tähän asti jäsenlista pystyi vain kasvamaan. Nyt voit poistaa '
        + 'jäsenen porukasta hänen omalta sivultaan. Henkilö katoaa paikkalistalta,'
        + ' joukkueista, '
        + 'tuloksista ja Palkinnoista; kaikki, mitä hän on joskus äänestänyt ja '
        + 'voittanut, jää '
        + 'täsmälleen ennalleen, eivätkä minkään pelin Spielwirbel-pisteet muutu '
        + 'siitä. Takaisin '
        + 'ottaminen onnistuu milloin tahansa. Jos paikka on syntynyt vahingossa '
        + 'eikä siihen '
    ...
    ko: {
      ...
      body: '모임은 변하기 마련인데, 지금까지 멤버 목록은 늘어나기만 했습니다. 이제 멤버 본인의 페이지에서 그 멤버를 모임에서 내보낼 수 있습니다. 해당 인물은 자리 '
        + '목록, 팀, 순위, 트로피에서 사라지지만, 그동안 투표하고 우승한 기록은 그대로 남고 어떤 게임의 Spielwirbel 점수도 이'
        + ' 때문에 바뀌지 않습니다. '
   ...
   */
  {
    ...
    es: {
      ...
      body: 'Al añadir un juego, al importarlo de BoardGameGeek y en la página del juego ahora '
        + 'puedes anotar a qué miembros pertenece — y quien anotaste la última vez '
        + 'se vuelve a '
        + 'sugerir. Eso cuenta en el sorteo: un juego cuyos dueños no juegan hoy ni'
        + ' siquiera '
        + 'entra en el bombo, y la pantalla de preparación dice cuántos faltan por '
        + 'ese motivo. '
        + 'Los juegos sin dueño anotado siguen entrando siempre, igual que antes, '
        + 'así que nada '
        + 'cambia mientras nadie anote nada. Quien juegue pero no haya traído sus '
        + 'juegos puede '
        + 'indicarlo al empezar la Session — entonces solo sus cajas se quedan '
        + 'fuera hoy y nada '
    ...
    fr: {
      ...
      body: 'En ajoutant un jeu, en le reprenant de BoardGameGeek et sur la page du jeu, vous '
        + 'pouvez maintenant noter à quels membres il appartient — et la personne '
        + 'notée la '
        + 'dernière fois est à nouveau proposée. Cela compte au tirage : un jeu dont les '
        + 'propriétaires ne jouent pas ce soir n’entre même pas dans le pot, et '
        + 'l’écran de '
        + 'préparation indique combien manquent pour cette raison. Les jeux sans '
        + 'propriétaire '
        + 'noté restent toujours de la partie, exactement comme avant : rien ne '
        + 'change tant que '
        + 'personne ne renseigne quoi que ce soit. Qui joue mais n’a pas apporté '
        + 'ses jeux peut le '
        + 'signaler au lancement de la Session — seules ses boîtes restent alors de côté '
        + 'aujourd’hui, et rien d’autre ne change à sa place. Le résultat indique '
        + 'enfin qui '
        + 'apporte la boîte.',
    },
    it: {
      ...
      body: 'Quando aggiungi un gioco, quando lo importi da BoardGameGeek e nella pagina del gioco '
        + 'puoi ora annotare a quali membri appartiene — e chi hai indicato '
        + 'l’ultima volta viene '
        + 'riproposto. Al sorteggio questo conta: un gioco i cui proprietari '
        + 'stasera non giocano '
        + 'non finisce nemmeno nel calderone, e la schermata di preparazione dice '
        + 'quanti mancano '
        + 'per questo motivo. I giochi senza proprietario indicato restano sempre '
        + 'in gioco, '
        + 'esattamente come prima: non cambia nulla finché nessuno annota qualcosa.'
        + ' Chi gioca ma '
        + 'non ha portato i suoi giochi può dirlo all’avvio della Session — solo le'
        + ' sue scatole '
        + 'restano fuori per oggi, e nulla altro cambia al suo posto. Alla fine il '
        + 'risultato dice '
    ...
    nl: {
      ...
      body: 'Bij het toevoegen van een spel, bij het overnemen uit BoardGameGeek en op de '
        + 'spelpagina kun je nu vastleggen van welke leden het spel is — en wie je '
        + 'de vorige keer '
        + 'koos, wordt meteen weer voorgesteld. Bij het loten telt dat mee: een '
        + 'spel waarvan de '
        + 'eigenaars vanavond niet meespelen komt niet eens in de pot, en het '
        + 'startscherm zegt '
        + 'hoeveel er om die reden afvallen. Spellen zonder eigenaar blijven altijd'
        + ' meedoen, '
        + 'precies als voorheen, dus er verandert niets zolang niemand iets invult.'
        + ' Wie meespeelt '
        + 'maar zijn spellen niet bij zich heeft, kan dat bij de start van de '
        + 'Session aangeven — '
        + 'dan blijven alleen zijn dozen vandaag buiten beeld en verandert er '
        + 'verder niets aan '
    ...
    pt: {
      ...
      body: 'Ao adicionar um jogo, ao importar do BoardGameGeek e na página do jogo agora dá para '
        + 'registrar a quais membros ele pertence — e quem você escolheu da última '
        + 'vez é sugerido '
        + 'de novo. Isso conta no sorteio: um jogo cujos donos não jogam hoje nem '
        + 'chega ao '
        + 'caldeirão, e a tela de preparação diz quantos faltam por esse motivo. '
        + 'Jogos sem dono '
        + 'registrado continuam entrando sempre, como antes, então nada muda '
        + 'enquanto ninguém '
        + 'preencher nada. Quem joga mas não trouxe seus jogos pode dizer isso ao '
        + 'iniciar a '
        + 'Session — aí só as caixas dessa pessoa ficam de fora hoje, e nada mais '
        + 'muda no lugar '
      ...
      body: 'Peliä lisätessä, BoardGameGeekistä tuotaessa ja pelin omalla sivulla voit nyt merkitä, '
        ...
        + 'Arvonnassa sillä on merkitystä: peli, jonka omistajat eivät pelaa '
        + 'tänään, ei päädy '
        + 'edes pataan, ja aloitusnäkymä kertoo, montako jää siksi pois. Pelit, '
        + 'joille ei ole '
        + 'merkitty omistajaa, ovat aina mukana kuten ennenkin, joten mikään ei '
        + 'muutu ennen kuin '
        + 'joku merkitsee jotain. Jos joku pelaa mutta ei ole tuonut pelejään '
        + 'mukanaan, sen voi '
        + 'kertoa Sessionia aloitettaessa — silloin vain hänen laatikkonsa jäävät '
        + 'tänään sivuun '
    ...
    ko: {
      ...
      body: '게임을 추가할 때, BoardGameGeek에서 가져올 때, 그리고 게임 페이지에서 이제 어떤 멤버의 게임인지 기록할 수 있고, 지난번에 고른 사람이 다시 '
        + '제안됩니다. 추첨할 때 이 정보가 반영됩니다. 주인이 오늘 참여하지 않는 게임은 아예 후보에 들어가지 않고, 준비 화면이 그 '
        + '이유로 몇 개가 빠졌는지 알려 '
        + '줍니다. 주인을 기록하지 않은 게임은 예전처럼 항상 후보에 남으므로, 아무도 입력하지 않는 한 달라지는 것은 없습니다. 참여는 '
        + '하지만 자기 게임을 가져오지 '
        + '않았다면 Session을 시작할 때 그렇게 지정할 수 있습니다. 그러면 오늘은 그 사람의 게임만 빠지고, 자리에 관한 다른 것은 '
        + '그대로입니다. 결과 '
   ...
   */
  {
    ...
    es: {
      ...
      body: 'Un juego ya puede estar en varios grupos. En los Ajustes de un grupo podéis mover '
        + 'juegos como hasta ahora — o, desde ahora, copiarlos: el juego se queda '
        + 'donde está y '
        + 'además aparece en la Estantería del otro grupo, con portada, número de '
        + 'jugadores, '
        + 'enlace y etiquetas. Las valoraciones y las Sessions se quedan con el '
        + 'grupo en el que '
        + 'realmente jugasteis. Los juegos que el otro grupo ya tiene vienen '
        + 'desmarcados de '
    ...
    fr: {
      ...
      body: 'Un jeu peut désormais figurer dans plusieurs groupes. Dans les Réglages d’un groupe, '
        + 'vous pouvez déplacer des jeux comme avant — ou maintenant les copier : '
        + 'le jeu reste où '
        + 'il est et arrive en plus dans l’Étagère de l’autre groupe, avec sa '
        + 'jaquette, son '
        + 'nombre de joueurs, son lien et ses étiquettes. Les évaluations et les '
        + 'Sessions restent '
        + 'attachées au groupe où vous avez réellement joué. Les jeux que l’autre '
        + 'groupe possède '
    ...
    it: {
      ...
      body: 'Un gioco può ora stare in più gruppi. Nelle Impostazioni di un gruppo potete spostare '
        + 'i giochi come sempre — oppure, da ora, copiarli: il gioco resta dov’è e '
        + 'finisce anche '
        + 'nello Scaffale dell’altro gruppo, con copertina, numero di giocatori, '
        + 'link e tag. '
        + 'Valutazioni e Session restano al gruppo in cui avete davvero giocato. I '
        + 'giochi che '
        + 'l’altro gruppo ha già sono deselezionati in partenza, così nulla finisce'
        + ' due volte '
        + 'sullo scaffale.',
    },
    nl: {
      ...
      body: 'Een spel kan nu in meerdere groepen staan. In de Instellingen van een groep kunnen '
        + 'jullie spellen verplaatsen zoals voorheen — of voortaan kopiëren: het '
        + 'spel blijft waar '
        + 'het is en komt er bovendien bij in de Kast van de andere groep, met cover, '
        + 'spelersaantal, link en tags. Beoordelingen en Sessions blijven bij de '
        + 'groep waarin '
        + 'jullie echt gespeeld hebben. Spellen die de andere groep al heeft, staan'
        + ' vooraf '
    ...
    pt: {
      ...
      body: 'Um jogo agora pode estar em mais de um grupo. Nas Configurações de um grupo vocês '
        + 'podem mover jogos como antes — ou, a partir de agora, copiá-los: o jogo '
        + 'continua onde '
        + 'está e também vai parar na Estante do outro grupo, com capa, número de '
        + 'jogadores, link '
        + 'e tags. Avaliações e Sessions ficam com o grupo em que vocês realmente '
        + 'jogaram. Os '
        + 'jogos que o outro grupo já tem vêm desmarcados de antemão, para que nada'
        + ' acabe duas '
        + 'vezes na estante.',
    },
    fi: {
      ...
      body: 'Peli voi nyt olla useammassa porukassa. Porukan Asetuksissa voitte siirtää pelejä '
        + 'kuten ennenkin — tai uutena kopioida ne: peli jää paikalleen ja päätyy '
        + 'lisäksi toisen '
        + 'porukan Hyllyyn kansikuvineen, pelaajamäärineen, linkkeineen ja '
        + 'tunnisteineen. Arviot '
        + 'ja Sessionit jäävät sille porukalle, jossa oikeasti pelasitte. Pelit, '
        + 'jotka toisella '
        + 'porukalla jo on, ovat valmiiksi valitsematta, jottei mikään päädy '
        + 'hyllyyn kahdesti.',
    },
    ko: {
      title: '다른 모임으로 게임 복사하기',
      body: '이제 한 게임이 여러 모임에 있을 수 있습니다. 모임 설정에서 예전처럼 게임을 옮길 수도 있고, 새로 추가된 복사를 쓸 수도 있습니다. 복사하면 게임은 '
        + '원래 자리에 그대로 남고 다른 모임의 선반에도 표지, 인원수, 링크, 태그와 함께 올라갑니다. 평가와 Session은 실제로 '
        + '플레이한 모임에 그대로 '
   ...
   */
  {
    ...
    es: {
      ...
      body: 'La valoración de un juego es ahora algo más que la media: si alguien no quiere jugar a '
        + 'un juego en absoluto, eso pesa más que una buena valoración de otra '
        + 'persona — para que '
        + 'al final se juegue a algo que apetece a todos. Cuando la puntuación se '
        + 'aparta de la '
        + 'media, justo al lado dice por qué. Un juego con pocas valoraciones '
        + 'todavía se juzga '
        + 'con más prudencia, y un juego que ponéis sobre la mesa una y otra vez, '
        + 'algo mejor.',
    },
    fr: {
      ...
      body: 'L’évaluation d’un jeu est maintenant plus qu’une moyenne : si quelqu’un ne veut pas du '
        + 'tout jouer à un jeu, cela pèse davantage qu’une bonne note de quelqu’un '
        + 'd’autre — pour '
        + 'qu’au bout du compte, on joue à ce dont tout le monde a envie. Quand le '
        + 'score s’écarte '
        + 'de la moyenne, la raison est indiquée juste à côté. Un jeu qui n’a '
        + 'encore que peu '
        + 'd’évaluations est jugé avec plus de prudence, et un jeu que vous '
        + 'remettez sans cesse '
    ...
    it: {
      ...
      body: 'La valutazione di un gioco è ora più della media: se qualcuno non vuole proprio '
        + 'giocare a un gioco, questo pesa più di un buon voto di qualcun altro — '
        + 'così alla fine '
        + 'si gioca a ciò che va bene a tutti. Quando il punteggio si discosta '
        + 'dalla media, '
        + 'accanto c’è scritto perché. Un gioco con ancora poche valutazioni viene '
        + 'giudicato con '
        + 'più cautela, e un gioco che rimettete in tavola di continuo un po’ più '
        + 'favorevolmente.',
    },
    nl: {
      ...
      body: 'De beoordeling van een spel is nu meer dan het gemiddelde: als iemand een spel '
        + 'helemaal niet wil spelen, weegt dat zwaarder dan een goede beoordeling '
        + 'van iemand '
        + 'anders — zodat er uiteindelijk iets gespeeld wordt waar iedereen zin in '
        + 'heeft. Wijkt '
        + 'de score af van het gemiddelde, dan staat er direct naast waarom. Een '
        + 'spel met nog '
        + 'maar weinig beoordelingen wordt voorzichtiger ingeschat, en een spel dat'
        + ' jullie steeds '
    ...
    pt: {
      ...
      body: 'A avaliação de um jogo agora é mais do que a média: se alguém não quer jogar um jogo '
        + 'de jeito nenhum, isso pesa mais do que uma boa nota de outra pessoa — '
        + 'para que no fim '
        + 'se jogue algo que agrada a todos. Quando a pontuação se afasta da média,'
        + ' logo ao lado '
        + 'está o motivo. Um jogo com poucas avaliações ainda é julgado com mais '
        + 'cautela, e um '
      ...
      body: 'Pelin arvio on nyt enemmän kuin keskiarvo: jos joku ei halua pelata peliä lainkaan, se '
        + 'painaa enemmän kuin jonkun toisen hyvä arvio — jotta lopulta pelataan '
        + 'sitä, mikä '
        + 'kaikkia kiinnostaa. Kun pisteet poikkeavat keskiarvosta, vieressä lukee '
        + 'miksi. Peliä, '
        + 'jolla on vasta vähän arvioita, arvioidaan varovaisemmin, ja peliä, jonka'
        + ' nostatte '
    ...
    ko: {
      ...
      body: '게임의 평가는 이제 단순한 평균 이상입니다. 누군가 어떤 게임을 전혀 하고 싶어 하지 않는다면, 그 의사가 다른 사람의 좋은 평가보다 더 크게 반영됩니다. '
        + '결국 모두가 내키는 게임을 하게 하기 위해서입니다. 점수가 평균과 다를 때는 그 이유가 바로 옆에 표시됩니다. 아직 평가가 적은 '
        + '게임은 더 조심스럽게 '
   ...
   */
  {
    ...
    es: {
      ...
      body: 'Ahora puedes darle una imagen a tu cuenta desde la pantalla Cuenta. Aparece allí donde '
        + 'ya aparece tu cuenta: en tu página de Perfil, en Amigos y en tu sitio '
        + 'dentro de un '
        + 'grupo. Sin imagen, todo sigue como antes con tus iniciales. Al subirla '
        + 'eliminamos los '
        + 'metadatos del archivo — también la ubicación GPS que llevan las fotos '
        + 'hechas con un '
    ...
    fr: {
      ...
      body: 'Vous pouvez désormais donner une image à votre compte depuis l’écran Compte. Elle '
        + 'apparaît partout où votre compte apparaît déjà : sur votre page de '
        + 'Profil, dans les '
        + 'Amis et à votre place dans un groupe. Sans image, tout reste comme avant'
        + ' avec vos '
        + 'initiales. À l’envoi, nous retirons les métadonnées du fichier — y '
        + 'compris la position '
        + 'GPS que portent les photos prises avec un appareil — et vous pouvez '
        + 'supprimer l’image '
        + 'à tout moment.',
    },
    it: {
      ...
      body: 'Ora puoi dare un’immagine al tuo account dalla schermata Account. Compare ovunque '
        + 'compaia già il tuo account: sulla tua pagina Profilo, negli Amici e al '
        + 'tuo posto in un '
        + 'gruppo. Senza immagine resta tutto come prima, con le tue iniziali. Al '
        + 'caricamento '
        + 'rimuoviamo i metadati del file — anche la posizione GPS che le foto '
        + 'scattate con un '
        + 'dispositivo portano con sé — e puoi cancellare l’immagine in qualsiasi '
        + 'momento.',
    },
    nl: {
      ...
      body: 'Je kunt je account nu vanuit het scherm Account een afbeelding geven. Die verschijnt '
        + 'overal waar je account toch al te zien is: op je Profiel-pagina, bij '
        + 'Vrienden en op je '
        + 'plek in een groep. Zonder afbeelding blijft alles zoals het was, met je '
        + 'initialen. Bij '
        + 'het uploaden verwijderen we de metadata van het bestand — ook de GPS-'
        + 'locatie die '
        + 'foto’s van een apparaat bij zich dragen — en je kunt de afbeelding '
        + 'altijd weer '
        + 'verwijderen.',
    },
    pt: {
      ...
      body: 'Agora você pode dar uma imagem à sua conta na tela Conta. Ela aparece em todo lugar '
        + 'onde a sua conta já aparece: na sua página de Perfil, nos Amigos e no '
        + 'seu lugar dentro '
        + 'de um grupo. Sem imagem, tudo continua como antes, com as suas iniciais.'
        + ' No envio '
        + 'removemos os metadados do arquivo — inclusive a localização GPS que '
        + 'fotos tiradas com '
      ...
      body: 'Voit nyt antaa tilillesi kuvan Tili-näkymässä. Se näkyy kaikkialla, missä tilisi '
        + 'muutenkin näkyy: Profiili-sivullasi, Kavereissa ja omalla paikallasi '
        + 'porukassa. Ilman '
        + 'kuvaa kaikki pysyy ennallaan nimikirjaimillasi. Poistamme lähetettäessä '
        + 'kuvatiedoston '
        + 'metatiedot — myös laitteella otettujen kuvien GPS-sijainnin — ja voit '
        + 'poistaa kuvan '
        + 'milloin tahansa.',
    },
    ko: {
      ...
      body: '이제 계정 화면에서 계정에 사진을 넣을 수 있습니다. 사진은 계정이 이미 표시되는 모든 곳에 나타납니다. 프로필 페이지, 친구 목록, 그리고 모임에서의 '
        + '자리입니다. 사진이 없으면 지금처럼 이니셜이 그대로 표시됩니다. 업로드할 때 이미지 파일의 메타데이터는 제거하며, 기기로 찍은 '
        + '사진에 담긴 GPS 위치도 '
   ...
   */
  {
    ...
    es: {
      ...
      body: 'En el Historial ahora podéis elegir un solo mes o un año entero: cuántas Sessions '
        + 'hubo, qué juegos llegaron a la mesa, a qué se jugó más y qué se valoró '
        + 'mejor, y qué '
        + 'entró en la estantería o salió de ella en ese tiempo. «Compartir» lo '
        + 'convierte en una '
    ...
    fr: {
      ...
      body: 'Dans l’Historique, vous pouvez maintenant choisir un mois précis ou une année entière '
        + ': combien de Sessions il y a eu, quels jeux sont arrivés sur la table, à'
        + ' quoi vous '
        + 'avez le plus joué et ce que vous avez le mieux noté, et ce qui a rejoint'
        + ' l’étagère ou '
        + 'l’a quittée pendant cette période. « Partager » en fait une image pour '
        + 'la discussion '
        + 'de groupe.',
    },
    it: {
      ...
      body: 'Nella Cronologia potete ora scegliere un singolo mese o un anno intero: quante Session '
        + 'ci sono state, quali giochi sono finiti in tavola, a cosa avete giocato '
        + 'di più e cosa '
        + 'avete valutato meglio, e cosa è arrivato sullo scaffale o l’ha lasciato '
        + 'in quel '
    ...
    nl: {
      ...
      body: 'In de Geschiedenis kunnen jullie nu één maand of een heel jaar kiezen: hoeveel '
        + 'Sessions het waren, welke spellen op tafel lagen, wat het vaakst '
        + 'gespeeld en het best '
        + 'beoordeeld werd, en wat er in die tijd in de kast kwam of eruit '
        + 'verdween. „Delen" '
    ...
    pt: {
      ...
      body: 'No Histórico vocês agora podem escolher um único mês ou um ano inteiro: quantas '
        + 'Sessions houve, quais jogos foram parar na mesa, o que foi mais jogado e'
        + ' melhor '
        + 'avaliado, e o que entrou na estante ou saiu dela nesse período. '
        + '«Compartilhar» '
      ...
      body: 'Historiassa voitte nyt valita yksittäisen kuukauden tai kokonaisen vuoden: montako '
        + 'Sessionia oli, mitkä pelit päätyivät pöydälle, mitä pelattiin eniten ja '
        + 'mikä sai '
        + 'parhaat arviot, ja mitä sinä aikana tuli hyllyyn tai lähti siitä. ”Jaa” '
        + 'tekee siitä '
        + 'kuvan ryhmächattiin.',
    },
    ko: {
      ...
      body: '기록 화면에서 이제 특정 한 달이나 한 해 전체를 고를 수 있습니다. Session이 몇 번이었는지, 어떤 게임이 테이블에 올랐는지, 무엇을 가장 많이 '
        + '플레이하고 무엇이 가장 좋은 평가를 받았는지, 그리고 그 기간에 무엇이 선반에 들어오고 나갔는지를 보여 줍니다. ‘공유’를 누르면'
        + ' 단체 대화방에 보낼 '
        + '이미지로 만들어 줍니다.',
    },
  },
   ...
   */
  {
    ...
    es: {
      ...
      body: 'La Estantería tiene ahora un modo «Seleccionar»: toca los juegos que quieras mientras '
        + 'la búsqueda y los filtros siguen funcionando — «Seleccionar todo» coge '
        + 'exactamente lo '
        + 'que hay en pantalla. Podéis retirar la selección o borrarla '
        + 'definitivamente en un solo '
        + 'paso. En Retirados, Completados y la Lista de deseos se puede hacer lo '
        + 'mismo para '
        + 'borrar.',
    },
    fr: {
      ...
      body: 'L’Étagère dispose maintenant d’un mode « Sélectionner » : touchez les jeux voulus, la '
        + 'recherche et les filtres continuant de fonctionner — « Tout sélectionner'
        + ' » prend '
        + 'exactement ce qui est à l’écran. Vous pouvez retirer la sélection ou la '
        + 'supprimer '
        + 'définitivement en une seule étape. Les écrans Retirés, Terminés et la '
        + 'Liste d’envies '
    ...
    it: {
      ...
      body: 'Lo Scaffale ha ora una modalità «Seleziona»: tocca i giochi che ti interessano mentre '
        + 'ricerca e filtri continuano a funzionare — «Seleziona tutto» prende '
        + 'esattamente ciò '
        + 'che è a schermo. La selezione può essere ritirata o eliminata '
        + 'definitivamente in un '
        + 'solo passaggio. Le schermate Ritirati, Completati e la Lista dei '
        + 'desideri offrono lo '
    ...
    nl: {
      ...
      body: 'De Kast heeft nu een modus „Selecteren": tik de spellen aan die je bedoelt terwijl '
        + 'zoeken en filters gewoon blijven werken — „Alles selecteren" pakt '
        + 'precies wat er in '
        + 'beeld staat. De selectie kunnen jullie in één stap opzijleggen of definitief '
        + 'verwijderen. Op Opzijgelegd, Uitgespeeld en de Verlanglijst kan '
        + 'hetzelfde om te '
        + 'verwijderen.',
    },
    pt: {
      ...
      body: 'A Estante agora tem um modo «Selecionar»: toque nos jogos que você quer enquanto a '
        + 'busca e os filtros continuam funcionando — «Selecionar tudo» pega '
        + 'exatamente o que '
        + 'está na tela. Vocês podem aposentar a seleção ou apagá-la de vez em um '
        + 'único passo. Em '
        + 'Aposentados, Concluídos e na Lista de desejos dá para fazer o mesmo para'
        + ' apagar.',
    },
    fi: {
      title: 'Koko hyllyn siivous kerralla',
      body: 'Hyllyssä on nyt ”Valitse”-tila: napauta haluamiasi pelejä samalla kun haku ja '
        + 'suodattimet toimivat normaalisti — ”Valitse kaikki” ottaa täsmälleen '
        + 'sen, mikä on '
        + 'näkyvissä. Valinnan voi karsia tai poistaa lopullisesti yhdellä kertaa. '
        + 'Karsitut, '
    ...
    ko: {
      ...
      body: '선반에 ‘선택’ 모드가 생겼습니다. 검색과 필터를 평소처럼 쓰면서 원하는 게임을 탭하면 되고, ‘전체 선택’은 지금 화면에 보이는 것만 정확히 집습니다. '
        + '선택한 게임은 한 번에 정리하거나 완전히 삭제할 수 있습니다. 정리한 게임, 완료한 게임, 위시리스트에서도 삭제를 같은 방식으로 '
        + '할 수 있습니다.',
    },
  },
  /*
   ...
   */
  {
    ...
    es: {
      ...
      body: '¿Sois demasiados para un solo juego? Marcad «Varias mesas» al sortear. Se vota una vez '
        + 'entre todos y, a continuación, la aplicación os propone repartos ya '
        + 'hechos para dos, '
        + 'tres o más mesas — con juego y distribución de sitios incluidos. Podéis '
        + 'cambiarlo todo '
    ...
    fr: {
      ...
      body: 'Trop nombreux pour un seul jeu ? Cochez « Plusieurs tables » au tirage. Tout le monde '
        + 'vote une seule fois ensemble, puis l’application vous propose des '
        + 'répartitions toutes '
        + 'prêtes sur deux, trois tables ou plus — jeu et placement compris. Vous '
        + 'pouvez tout '
        + 'réorganiser à la main et voir aussitôt à quel point chaque table est '
        + 'satisfaite.',
    },
    it: {
      title: 'Più tavoli in una Session',
      body: 'Troppi per un solo gioco? Spuntate «Più tavoli» al sorteggio. Si vota una volta sola '
        + 'tutti insieme, poi l’app vi propone suddivisioni già pronte su due, tre '
        + 'o più tavoli — '
        + 'gioco e disposizione dei posti compresi. Potete riorganizzare tutto a '
        + 'mano e vedere '
    ...
    nl: {
      ...
      body: 'Met te veel voor één spel? Zet bij het loten een vinkje bij „Meerdere tafels". Er '
        + 'wordt één keer samen gestemd, waarna de app jullie kant-en-klare '
        + 'verdelingen over '
        + 'twee, drie of meer tafels voorstelt — inclusief spel en zitindeling. '
        + 'Jullie kunnen '
    ...
    pt: {
      ...
      body: 'Gente demais para um jogo só? Marquem «Várias mesas» no sorteio. Vota-se uma vez só, '
        + 'todos juntos, e depois o app propõe divisões prontas em duas, três ou '
        + 'mais mesas — com '
        + 'jogo e disposição dos lugares. Vocês podem remanejar tudo à mão e ver na'
        + ' hora o quanto '
      ...
      body: 'Liikaa väkeä yhteen peliin? Rastittakaa arvonnassa ”Useampi pöytä”. Äänestetään kerran '
        + 'yhdessä, minkä jälkeen sovellus ehdottaa valmiita jakoja kahdelle, '
        + 'kolmelle tai '
        + 'useammalle pöydälle — peli ja istumajärjestys mukaan lukien. Voitte '
        + 'järjestää kaiken '
   ...
   */
  {
    ...
    es: {
      ...
      body: 'La Estantería de un grupo tiene ahora abajo un enlace «También os puede gustar»: '
        + 'juegos que todavía no tenéis, elegidos a partir de vuestra propia '
        + 'estantería y de '
        + 'vuestras propias valoraciones. Cada sugerencia dice por qué está ahí — y'
        + ' con un toque '
    ...
    fr: {
      ...
      body: 'L’Étagère d’un groupe propose maintenant en bas un lien « Ça pourrait vous plaire » : '
        + 'des jeux que vous n’avez pas encore, choisis à partir de votre propre '
        + 'étagère et de '
        + 'vos propres évaluations. Chaque suggestion dit pourquoi elle est là — et'
        + ' une touche la '
    ...
    it: {
      ...
      body: 'Lo Scaffale di un gruppo ha ora in fondo un collegamento «Potrebbe piacervi anche»: '
        ...
        + 'valutazioni. Ogni proposta dice perché è lì — e un tocco la mette nella '
        + 'Lista dei '
        + 'desideri.',
    },
    nl: {
      ...
      body: 'De Kast van een groep heeft onderaan nu een link „Misschien ook iets voor jullie": '
        + 'spellen die jullie nog niet hebben, gekozen op basis van jullie eigen '
        + 'kast en jullie '
        + 'eigen beoordelingen. Elke suggestie zegt erbij waarom hij er staat — en '
        + 'één tik zet '
    ...
    pt: {
      ...
      body: 'A Estante de um grupo agora tem lá embaixo um link «Você também pode gostar»: jogos '
        + 'que vocês ainda não têm, escolhidos a partir da estante de vocês e das '
        + 'avaliações de '
        + 'vocês. Cada sugestão diz por que está ali — e um toque a coloca na Lista'
        + ' de desejos.',
    },
    fi: {
      ...
      body: 'Porukan Hyllyn alalaidassa on nyt linkki ”Saattaisit pitää myös näistä”: pelejä, joita '
        + 'teillä ei vielä ole, valittuna oman hyllynne ja omien arvioidenne '
        + 'perusteella. '
        + 'Jokainen ehdotus kertoo, miksi se on mukana — ja yhdellä napautuksella '
        + 'se siirtyy '
        + 'Toivelistalle.',
    },
    ko: {
   ...
   */
  {
    ...
    es: {
      ...
      body: 'En «Descubrir» ahora se ve qué ocurre en Spielwirbel en su conjunto: cuánto se ha '
        + 'reunido aquí y qué juegos están ahora mismo en especialmente muchas '
        + 'estanterías, se '
        + 'juegan especialmente a menudo o reciben especialmente buenas '
        + 'valoraciones. Encontrarás '
        + 'la página en este menú.',
    },
    fr: {
      title: 'Découvrir',
      body: 'Sous « Découvrir », on voit maintenant ce qui se passe sur Spielwirbel dans son '
        + 'ensemble : tout ce qui s’est rassemblé ici, et quels jeux sont en ce '
        + 'moment dans '
    ...
    it: {
      ...
      body: 'In «Esplora» si vede ora cosa succede su Spielwirbel nel suo insieme: quanto si è '
        ...
        + 'scaffali, vengono giocati particolarmente spesso o valutati '
    ...
    nl: {
      ...
      body: 'Onder „Ontdekken" staat nu wat er op Spielwirbel als geheel gebeurt: hoeveel er hier '
        + 'is samengekomen en welke spellen op dit moment in bijzonder veel kasten '
        + 'staan, '
        + 'bijzonder vaak gespeeld of bijzonder goed beoordeeld worden. Je vindt de'
        + ' pagina in dit '
        + 'menu.',
    },
    pt: {
      ...
      body: 'Em «Descobrir» agora dá para ver o que acontece no Spielwirbel como um todo: quanto já '
        + 'se juntou por aqui e quais jogos estão neste momento em especialmente '
        + 'muitas estantes, '
        + 'são jogados com especial frequência ou recebem avaliações especialmente '
        + 'boas. Você '
      ...
      body: 'Kohdassa ”Löydä” näkyy nyt, mitä Spielwirbelissä kaiken kaikkiaan tapahtuu: kuinka '
        + 'paljon tänne on kertynyt ja mitkä pelit ovat juuri nyt erityisen monessa'
        + ' hyllyssä, '
