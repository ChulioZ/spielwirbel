...
I18N.en = {
  ...
  'activity.memberRetired': '{name} was retired',
  'activity.memberRestored': '{name} is back',
  ...
  'member.retire': 'Retire',
  'member.restore': 'Bring back',
  'member.delete': 'Delete seat',
  'member.retiredTitle': '{name} · retired',
  'member.retireConfirm': 'Retire {name}? They leave the seating list, the teams and the standings — everything they have already voted on and won stays exactly as it is.',
  ...
  'member.toast.retired': '{name} is retired',
  'member.toast.restored': '{name} is back',
