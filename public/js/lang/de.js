...
I18N.de = {
  ...
  'pokale.wins': '{n} Siege',
  'pokale.winWordOne': 'Sieg',
  'pokale.winWord': 'Siege',
  ...
  'wish.acquireExpansion': 'Als Erweiterung eintragen',
  ...
  'result.keepSession': 'Weiterspielen',
  ...
  'marker.programmheft.zinnober': 'Zinnober',
  'marker.programmheft.preussischblau': 'Preußischblau',
  'marker.programmheft.tannengruen': 'Tannengrün',
  'marker.programmheft.ocker': 'Ocker',
  'marker.programmheft.pflaume': 'Pflaume',
  'marker.programmheft.graphit': 'Graphit',
  'marker.programmheft.petrol': 'Petrol',
  'marker.programmheft.fuchsie': 'Fuchsie',
  ...
  'design.programmheft.name': 'Das Programmheft',
  'design.programmheft.desc': 'Wie ein gedrucktes Programm: schwarz auf Papier, große Ziffern und ein einziges Rot.',
  'design.programmheft.tagline': 'Papier, Zinnober, große Ziffern',
  'design.programmheft.short': 'Schwarz auf Papier, ein Zinnoberrot',
  ...
  'badges.state.earned': 'Verdient',
  'badges.state.progress': 'Unterwegs',
  'badges.state.locked': 'Offen',
  'badges.state.secret': 'Geheim',
  'badges.secretLine': 'Wird sichtbar, sobald es jemand verdient',
  'badges.firstWin.name': 'Erster Sieg',
  'badges.firstWin.line': 'Die erste Session gewonnen',
  'badges.regular.name': 'Stammgast',
  'badges.regular.line': 'Bei {n} Sessions dabei',
  'badges.streak.name': 'Serienheld',
  'badges.streak.line': '{n} Sessions in Folge gewonnen',
  'badges.versatile.name': 'Vielseitig',
  'badges.versatile.line': 'Mit {n} verschiedenen Spielen gewonnen',
  'badges.allPlayed.name': 'Alles gespielt',
  'badges.allPlayed.line': 'Jedes Spiel im Regal mindestens einmal gespielt',
  'badges.teamPlayer.name': 'Teamgeist',
  'badges.teamPlayer.line': 'Als Teil eines Teams gewonnen',
  'badges.host.name': 'Gastgeber',
  'badges.host.line': 'Die eigene Schachtel kam {n}-mal auf den Tisch',
  'badges.comeback.name': 'Comeback',
  'badges.comeback.line': 'Gewonnen nach {n} Sessions ohne Sieg',
  'badges.explorer.name': 'Entdecker',
  'badges.explorer.line': '{n} neue Spiele in ihrer ersten Woche mitgespielt',
  'badges.founded.name': 'Gegründet',
  'badges.founded.line': 'Die erste Session beendet',
  'badges.sessions.name': 'Sessions',
  'badges.sessions.line': '{n} Sessions beendet',
  'badges.shelf.name': 'Regal',
  'badges.shelf.line': '{n} Spiele im Regal',
  'badges.unanimous.name': 'Einstimmig',
  'badges.unanimous.line': 'Alle gaben dem Siegerspiel die beste Wertung',
  'badges.tie.name': 'Unentschieden',
  'badges.tie.line': 'Eine Abstimmung endete gleichauf',
  'badges.bigTable.name': 'Große Runde',
  'badges.bigTable.line': '{n} oder mehr am Tisch, Gäste zählen mit',
  'badges.completed.name': 'Durchgespielt',
  ...
  'badges.accountWins.line': '{n} Siege in allen Runden',
  'badges.accountRounds.name': 'Runden',
  'badges.accountRounds.line': 'In {n} Runden dabei',
  'badges.accountYears.name': 'Jahre',
  'badges.accountYears.line': '{n} Jahre bei Spielwirbel',
  'badges.accountYears.lineOne': '{n} Jahr bei Spielwirbel',
  ...
  'badges.newMark': 'Neu',
  'badges.count.earnedOne': '{n} verdient',
  'badges.count.earned': '{n} verdient',
  'badges.count.progressOne': '{n} unterwegs',
  ...
  'badges.newOne': '{n} neu',
  'badges.new': '{n} neu',
  'badges.ofTotal': '{n} von {total}',
  'badges.empty': 'Nach der ersten Session gibt es hier die ersten Abzeichen.',
  'badges.hub.newOne': '{n} neues Abzeichen seit {game}',
  'badges.hub.new': '{n} neue Abzeichen seit {game}',
  'badges.hub.newBareOne': '{n} neues Abzeichen',
  'badges.hub.newBare': '{n} neue Abzeichen',
  'badges.hub.latest': 'Zuletzt: {name} · {holder}',
