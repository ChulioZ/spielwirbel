...
I18N.de = {
  ...
  'activity.memberRetired': '{name} wurde aussortiert',
  'activity.memberRestored': '{name} ist zurück',
  ...
  'member.retire': 'Aussortieren',
  'member.restore': 'Zurückholen',
  'member.delete': 'Platz löschen',
  'member.retiredTitle': '{name} · aussortiert',
  'member.retireConfirm': '{name} aussortieren? Die Person verschwindet aus der Sitzliste, den Teams und den Wertungen — alles, was sie schon abgestimmt und gewonnen hat, bleibt genau so.',
  ...
  'member.toast.retired': '{name} ist aussortiert',
  'member.toast.restored': '{name} ist zurück',
