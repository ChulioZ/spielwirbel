...
**German + English + Spanish**; code, comments here, and docs are **English**.
...
- The UI ships German + English + Spanish today. **Never hard-code user-facing
  text in views.** Add a key to **every** `public/js/lang/*.js` file (en, de and
  es today),
