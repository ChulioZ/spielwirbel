...
Finnish**; code, comments here, and docs are **English**.
...
- The UI ships German + English + Spanish + French + Italian + Dutch +
  Portuguese + Finnish today. **Never hard-code user-facing text in views.** Add
  a key to **every** `public/js/lang/*.js` file (en, de, es, fr, it, nl, pt and
  fi today),
